...
public class Linear_Search_LL_p1_28
{
    class Node
    {
        int data;
    ...
    public int LinSearch(int key)
    {
        ...
        while(temp!=null)
        {
            if(temp.data==key)//key has been found
            {
                return i;
            }
            temp=temp.next;
    ...
    {
        Linear_Search_LL_p1_28 ll=new Linear_Search_LL_p1_28();
        ...
        ll.add_last(4);
        ll.print();
        System.out.println(ll.LinSearch(3));
        System.out.println(ll.LinSearch(10));
    }
}
